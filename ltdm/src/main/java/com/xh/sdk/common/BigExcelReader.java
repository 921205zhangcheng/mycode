...
//                      }  
    ...
    public  void outputRow(String[] datas, int[] rowTypes, int rowIndex){
    	String productCode="90000918";
     	if(datas.length>2){
    	String zhiling = datas[1];
    	String tuiding="TD"+zhiling;
   
    switch (Integer.valueOf(zhiling)) {
	case 83:
		productCode = "90001403";
		break;
	case 86:
		productCode = "90001406";
		break;
	case 89:
		productCode = "90001409";
		break;
	case 90:
		productCode = "90001410";
		break;
	case 812:
		productCode = "90000918";
		break;
	case 813:
		productCode = "90000919";
		break;
	case 815:
		productCode = "90000921";
		break;
	case 817:
		productCode = "90000923";
		break;
	case 818:
		productCode = "90000924";
		break;
	case 819:
		productCode = "90000925";
		break;
	default:
		break;
	}
        String time = datas[2].replace("/", "-");
        String str = "";
    	...
    	str = "10655502\t"+datas[0]+"\t"+datas[0]+"\t"+productCode+"\t"+datas[1]+"\t"+tuiding+"\t"+time+"\t"+"1"+"\n";
    	
    	appendMethodB("d:/test.txt", str);
    ...
    private static void appendMethodB(String fileName, String content) {  
    	Path path= Paths.get(fileName);
           ...
           // BufferedWriter writer=Files.newBufferedWriter(path, Charset.forName("utf-8"));
			...
			try {
				writer = Files.newBufferedWriter(path, Charset.forName("utf-8"), StandardOpenOption.APPEND);
