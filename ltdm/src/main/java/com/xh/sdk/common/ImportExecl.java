...
{  
    ...
    {  
        ...
        List<List<String>> list = poi.read("e:/123.xlsx");  
        ...
        {  
   		...
   		try {
   			...
   			e.printStackTrace();
                ...
                str = "10655502\t"+cellList.get(0)+"\t"+cellList.get(0)+"\t"+productCode+"\t"+cellList.get(1)+"\t"+tuiding+"\t"+time+"\t"+"1"+"\n";
